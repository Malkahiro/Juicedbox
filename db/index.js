...
const updatePost = async (postId, fields = {}) => {
  ...
  try {
    ...
    console.log(`This is the Tag List Id String ${tagListIdString}`);
    ...
    `, [postId]);  
      ...
      console.log(`This is the current tag list ${tagList[1].id}`);
...
const createTags = async (tagList) =>{
  ...
  console.log(`This is the tag list ${tagList}`);
